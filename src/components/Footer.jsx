      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap text-left lg:text-left">
          <div className="w-full lg:w-6/12 px-4">
            <h4 className="text-3xl font-semibold text-blue-800 ">POAPs Generated</h4>
            <h5 className="text-[2rem] leading-[3rem] tracking-tight font-bold text-black dark:text-white">
            Únase a nosotros en las redes sociales para conocer las últimas actualizaciones sobre la creación y acuñación de Poap.
            </h5>
